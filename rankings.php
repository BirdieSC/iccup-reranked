...
<?php
				...
				{
					$i = $i + 1;
					echo "<tr>" . "<td>" . $i . "</td> " . "<td><a name=" . $row['name'] .">" . "<a href=\"http://www.iccup.com/starcraft/gamingprofile/" . $row['name'] . ".html\">" . $row['name'] . "</td><td>" . $row['elo'] . " &plusmn; " . $row['rdeviation'] . "</td><td>" . $row['played'] . "</td><td>" . $row['won'] . "</td><td>" . $row['lost'] . "</tr>";
