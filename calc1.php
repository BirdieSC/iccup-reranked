...
// Connect to MySQL
$link = mysql_connect("TOP","SEKRIT","INFO");
if (!$link) {
    die('Could not connect: ' . mysql_error());
}
mysql_select_db("jack_iccup_ranking") or die (mysql_error());
		$select_maxid = mysql_query("SELECT MAX(ID) FROM matches");
		...
		for($i = 1; $i <= $max_id; $i++)
			{
$grabMatchRow = mysql_query("SELECT * FROM matches WHERE id = '$i'");
...
if (!mysql_fetch_row($result))
	...
	mysql_query("INSERT INTO players (id, name, elo, rdeviation, played, won, lost) VALUES ('$newMaxID', '$table', 1500, 300, 0, 0, 0)") or die(mysql_error());
...
if (!mysql_fetch_row($result2))
	...
	mysql_query("INSERT INTO players (id, name, elo, rdeviation, played, won, lost) VALUES ('$newMaxID', '$table2', 1500, 300, 0, 0, 0)") or die(mysql_error());
									echo "Table created!<br />";
	}
